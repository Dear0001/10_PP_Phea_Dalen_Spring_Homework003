...
public class EventController {
    ...
    public ResponseEntity<?> getAllEvents(@RequestParam(required = false, defaultValue = "1") int numberPage,
    ...
    public ResponseEntity<?> createEvent(@RequestParam EventRequest eventRequest) {
